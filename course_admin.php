...
<?php 
  if (isset($_GET['edit'])) {
    $course_id = $_GET['edit'];
    $update = true;
    $record = mysqli_query($connection, "SELECT * FROM course WHERE id=$course_id");
        ...
        <div class="container-fluid">
            <a class="navbar-brand" style="color: white;">Home</a>
              ...
              <div class="col-md-9 grid-margin stretch-card" style="margin-left: 10%; ">
                <div class="card">
                  <div class="card-body">
                    <center><h4 class="card-title">Add Cources</h4></center>
                    ...
                    <form class="forms-sample" method="post" action="database_controller.php">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="course_name" class="form-control" id="exampleInputUsername2" placeholder="eg Database Management System" value="<?php if (isset($_GET['edit'])) { echo $name ; } ?>">
                        </div>
                      </div>
                    ...
                    <?php  
                        ...
                        <button style="padding-left: 80px; padding-right: 80px;" type="submit"   class="btn btn-primary mr-6" name="submit_edit_course" value="submit_edit_course">Update
                        </button>
                    <?php  else:  ?>
                        <button style="padding-left: 80px; padding-right: 80px;" type="submit" name="submit_add_course" value="submit_add_course" class="btn btn-primary mr-6" >Submit
                        </button>
                    <?php endif ?>
                  </center>
        ...
        <tr>
          ...
          ?>
            ...
            <td>
              <div class="row">
                  <div class="col-md-3">
                    <a href="course_admin.php?edit=<?php echo $row_course['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                  </div>
                  <div class="col-md-9">
                    <!-- <form method="post" action="database_controller.php"> -->
                        <a href="del/course_del.php?del_course_id=<?php echo $row_course['id']; ?>" type="button" class="btn btn-secondary btn-sm">
                          Delete
                        </a>
                    <!-- </form> -->
                </div>
